...
Gem::Specification.new do |gem|
  ...
  gem.requirements               = []
  gem.add_runtime_dependency     'rdf',                '~> 1.1', '>= 1.1.13', '< 1.99'
  gem.add_runtime_dependency     'rdf-aggregate-repo', '~> 1.1', '>= 1.1.0', '< 1.99'
  gem.add_runtime_dependency     'ebnf',               '~> 1.0'
  gem.add_runtime_dependency     'builder',            '~> 3.2'
  gem.add_runtime_dependency     'sxp',                '~> 0.1'
  gem.add_runtime_dependency     'sparql-client',      '~> 1.1', '< 1.99'
  ...
  gem.add_development_dependency 'linkeddata',         '~> 1.1', '< 1.99'
