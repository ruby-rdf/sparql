...
module SPARQL::Grammar::Meta
  ...
  BRANCH = {
    ...
    :_AdditiveExpression_10 => {
      "*" => [:_AdditiveExpression_9, :_AdditiveExpression_8],
      "/" => [:_AdditiveExpression_9, :_AdditiveExpression_8],
    },
    ...
    :_AnnotationPath_2 => {
      "{|" => [:_AnnotationPath_1, :AnnotationPath],
      "~" => [:_AnnotationPath_1, :AnnotationPath],
    },
    :_Annotation_1 => {
      "{|" => [:AnnotationBlock],
    ...
    :AskQuery => {
      "ASK" => ["ASK", :_AskQuery_1, :WhereClause, :SolutionModifier, :ValuesClause],
    },
    :_AskQuery_1 => {
      "FROM" => [:_AskQuery_2],
      "WHERE" => [],
    ...
    :BuiltInCall => {
      ...
      "NOT" => [:NotExistsFunc],
      "NOW" => [:_BuiltInCall_32],
      "OBJECT" => [:_BuiltInCall_56],
      "PREDICATE" => [:_BuiltInCall_55],
      "RAND" => [:_BuiltInCall_9],
    ...
    :Object => {
      ...
      "<<" => [:GraphNode, :Annotation],
      "<<(" => [:GraphNode, :Annotation],
      :ANON => [:GraphNode, :Annotation],
      :BLANK_NODE_LABEL => [:GraphNode, :Annotation],
      :DECIMAL => [:GraphNode, :Annotation],
      :DECIMAL_NEGATIVE => [:GraphNode, :Annotation],
      :DECIMAL_POSITIVE => [:GraphNode, :Annotation],
      :DOUBLE => [:GraphNode, :Annotation],
      :DOUBLE_NEGATIVE => [:GraphNode, :Annotation],
      :DOUBLE_POSITIVE => [:GraphNode, :Annotation],
      :INTEGER => [:GraphNode, :Annotation],
      :INTEGER_NEGATIVE => [:GraphNode, :Annotation],
      :INTEGER_POSITIVE => [:GraphNode, :Annotation],
      :IRIREF => [:GraphNode, :Annotation],
      :NIL => [:GraphNode, :Annotation],
      :PNAME_LN => [:GraphNode, :Annotation],
      :PNAME_NS => [:GraphNode, :Annotation],
      :STRING_LITERAL1 => [:GraphNode, :Annotation],
      :STRING_LITERAL2 => [:GraphNode, :Annotation],
      :STRING_LITERAL_LONG1 => [:GraphNode, :Annotation],
      :STRING_LITERAL_LONG2 => [:GraphNode, :Annotation],
      :VAR1 => [:GraphNode, :Annotation],
      :VAR2 => [:GraphNode, :Annotation],
      "[" => [:GraphNode, :Annotation],
      "false" => [:GraphNode, :Annotation],
      "true" => [:GraphNode, :Annotation],
    },
    :ObjectList => {
    ...
    :ObjectPath => {
      ...
      "<<" => [:GraphNodePath, :AnnotationPath],
      "<<(" => [:GraphNodePath, :AnnotationPath],
      :ANON => [:GraphNodePath, :AnnotationPath],
      :BLANK_NODE_LABEL => [:GraphNodePath, :AnnotationPath],
      :DECIMAL => [:GraphNodePath, :AnnotationPath],
      :DECIMAL_NEGATIVE => [:GraphNodePath, :AnnotationPath],
      :DECIMAL_POSITIVE => [:GraphNodePath, :AnnotationPath],
      :DOUBLE => [:GraphNodePath, :AnnotationPath],
      :DOUBLE_NEGATIVE => [:GraphNodePath, :AnnotationPath],
      :DOUBLE_POSITIVE => [:GraphNodePath, :AnnotationPath],
      :INTEGER => [:GraphNodePath, :AnnotationPath],
      :INTEGER_NEGATIVE => [:GraphNodePath, :AnnotationPath],
      :INTEGER_POSITIVE => [:GraphNodePath, :AnnotationPath],
      :IRIREF => [:GraphNodePath, :AnnotationPath],
      :NIL => [:GraphNodePath, :AnnotationPath],
      :PNAME_LN => [:GraphNodePath, :AnnotationPath],
      :PNAME_NS => [:GraphNodePath, :AnnotationPath],
      :STRING_LITERAL1 => [:GraphNodePath, :AnnotationPath],
      :STRING_LITERAL2 => [:GraphNodePath, :AnnotationPath],
      :STRING_LITERAL_LONG1 => [:GraphNodePath, :AnnotationPath],
      :STRING_LITERAL_LONG2 => [:GraphNodePath, :AnnotationPath],
      :VAR1 => [:GraphNodePath, :AnnotationPath],
      :VAR2 => [:GraphNodePath, :AnnotationPath],
      "[" => [:GraphNodePath, :AnnotationPath],
      "false" => [:GraphNodePath, :AnnotationPath],
      "true" => [:GraphNodePath, :AnnotationPath],
    },
    :OffsetClause => {
    ...
    :_PropertyListPathNotEmpty_6 => {
      "!" => [:_PropertyListPathNotEmpty_7, :ObjectListPath],
      "(" => [:_PropertyListPathNotEmpty_7, :ObjectListPath],
      :IRIREF => [:_PropertyListPathNotEmpty_7, :ObjectListPath],
      :PNAME_LN => [:_PropertyListPathNotEmpty_7, :ObjectListPath],
      :PNAME_NS => [:_PropertyListPathNotEmpty_7, :ObjectListPath],
      :VAR1 => [:_PropertyListPathNotEmpty_7, :ObjectListPath],
      :VAR2 => [:_PropertyListPathNotEmpty_7, :ObjectListPath],
      "^" => [:_PropertyListPathNotEmpty_7, :ObjectListPath],
      "a" => [:_PropertyListPathNotEmpty_7, :ObjectListPath],
    },
    ...
    :ReifiedTriple => {
      "<<" => ["<<", :_ReifiedTriple_1, :Verb, :_ReifiedTriple_2, :_ReifiedTriple_3, ">>"],
    },
    :ReifiedTripleBlock => {
    ...
    :_Reifier_1 => {
      ...
      :ANON => [:VarOrReifierId],
      "BIND" => [],
      :BLANK_NODE_LABEL => [:VarOrReifierId],
      "FILTER" => [],
      "GRAPH" => [],
      :IRIREF => [:VarOrReifierId],
      "MINUS" => [],
      "OPTIONAL" => [],
      :PNAME_LN => [:VarOrReifierId],
      :PNAME_NS => [:VarOrReifierId],
      "SERVICE" => [],
      "VALUES" => [],
      :VAR1 => [:VarOrReifierId],
      :VAR2 => [:VarOrReifierId],
    ...
    :TripleTermData => {
      "<<(" => ["<<(", :DataValueTerm, :_TripleTermData_1, :DataValueTerm, ")>>"],
    },
    :_TripleTermData_1 => {
      :IRIREF => [:iri],
      :PNAME_LN => [:iri],
  ...
  FIRST = {
    ...
    :_ReifiedTripleData_1 => [
      ...
      :DECIMAL_NEGATIVE,
      :DOUBLE_NEGATIVE],
    :_ReifiedTripleData_2 => [
      "a",
      :IRIREF,
      :PNAME_LN,
      :PNAME_NS],
    :_ReifiedTripleData_3 => [
      "<<",
      "<<(",
      :IRIREF,
      "true",
      ...
      :DECIMAL_NEGATIVE,
      :DOUBLE_NEGATIVE],
    :_ReifiedTripleData_4 => [
      "~",
      :_eps],
    :_ReifiedTripleData_5 => [
      "<<",
      "<<(",
      :IRIREF,
      "true",
      ...
      :DECIMAL_NEGATIVE,
      :DOUBLE_NEGATIVE],
    :_ReifiedTripleData_6 => [
      "a",
      :IRIREF,
      :PNAME_LN,
      :PNAME_NS],
    :_ReifiedTripleData_7 => [
      "<<",
      "<<(",
      :IRIREF,
      "true",
      ...
      :DECIMAL_NEGATIVE,
      :DOUBLE_NEGATIVE],
    :_ReifiedTripleData_8 => [
      "~",
      ">>"],
    :_ReifiedTripleData_9 => [
      ">>"],
    :_ReifiedTriple_1 => [
      :NIL,
      "<<",
  ...
  CLEANUP = {
    ...
    :_AdditiveExpression_10 => :merge,
    :_AdditiveExpression_3 => :merge,
    :_AdditiveExpression_8 => :star,
    :_Aggregate_10 => :opt,
    :_Aggregate_11 => :opt,
    :_Aggregate_12 => :opt,
    :_Aggregate_13 => :opt,
    ...
    :_ReifiedTripleData_4 => :opt,
    :_ReifiedTriple_3 => :opt,
    :_ReifierData_1 => :opt,
    :_Reifier_1 => :opt,
