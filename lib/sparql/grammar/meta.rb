...
module SPARQL::Grammar::Meta
  ...
  BRANCH = {
    ...
    :BuiltInCall => {
      ...
      "SHA1" => [:_BuiltInCall_34],
      "SHA224" => [:_BuiltInCall_35],
      "SHA256" => [:_BuiltInCall_36],
      "SHA384" => [:_BuiltInCall_37],
      "SHA512" => [:_BuiltInCall_38],
      "STR" => [:_BuiltInCall_1],
      "STRAFTER" => [:_BuiltInCall_23],
      "STRBEFORE" => [:_BuiltInCall_22],
      "STRDT" => [:_BuiltInCall_42],
      "STRENDS" => [:_BuiltInCall_21],
      "STRLANG" => [:_BuiltInCall_41],
      ...
      "isBLANK" => [:_BuiltInCall_46],
      "isIRI" => [:_BuiltInCall_44],
      "isLITERAL" => [:_BuiltInCall_47],
      "isNUMERIC" => [:_BuiltInCall_48],
      "isURI" => [:_BuiltInCall_45],
      "sameTerm" => [:_BuiltInCall_43],
    },
    :_BuiltInCall_1 => {
      "STR" => ["STR", "(", :Expression, ")"],
    },
