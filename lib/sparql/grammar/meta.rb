...
module SPARQL::Grammar::Meta
  ...
  BRANCH = {
    ...
    :ObjectList => {
      "(" => [:Object, :_ObjectList_1, :_ObjectList_2],
      "<<" => [:Object, :_ObjectList_1, :_ObjectList_2],
      :ANON => [:Object, :_ObjectList_1, :_ObjectList_2],
      :BLANK_NODE_LABEL => [:Object, :_ObjectList_1, :_ObjectList_2],
      :DECIMAL => [:Object, :_ObjectList_1, :_ObjectList_2],
      :DECIMAL_NEGATIVE => [:Object, :_ObjectList_1, :_ObjectList_2],
      :DECIMAL_POSITIVE => [:Object, :_ObjectList_1, :_ObjectList_2],
      :DOUBLE => [:Object, :_ObjectList_1, :_ObjectList_2],
      :DOUBLE_NEGATIVE => [:Object, :_ObjectList_1, :_ObjectList_2],
      :DOUBLE_POSITIVE => [:Object, :_ObjectList_1, :_ObjectList_2],
      :INTEGER => [:Object, :_ObjectList_1, :_ObjectList_2],
      :INTEGER_NEGATIVE => [:Object, :_ObjectList_1, :_ObjectList_2],
      :INTEGER_POSITIVE => [:Object, :_ObjectList_1, :_ObjectList_2],
      :IRIREF => [:Object, :_ObjectList_1, :_ObjectList_2],
      :NIL => [:Object, :_ObjectList_1, :_ObjectList_2],
      :PNAME_LN => [:Object, :_ObjectList_1, :_ObjectList_2],
      :PNAME_NS => [:Object, :_ObjectList_1, :_ObjectList_2],
      :STRING_LITERAL1 => [:Object, :_ObjectList_1, :_ObjectList_2],
      :STRING_LITERAL2 => [:Object, :_ObjectList_1, :_ObjectList_2],
      :STRING_LITERAL_LONG1 => [:Object, :_ObjectList_1, :_ObjectList_2],
      :STRING_LITERAL_LONG2 => [:Object, :_ObjectList_1, :_ObjectList_2],
      :VAR1 => [:Object, :_ObjectList_1, :_ObjectList_2],
      :VAR2 => [:Object, :_ObjectList_1, :_ObjectList_2],
      "[" => [:Object, :_ObjectList_1, :_ObjectList_2],
      "false" => [:Object, :_ObjectList_1, :_ObjectList_2],
      "true" => [:Object, :_ObjectList_1, :_ObjectList_2],
    },
    :ObjectListPath => {
      ...
      :STRING_LITERAL1 => [:ObjectPath, :_ObjectListPath_1, :_ObjectListPath_2],
    ...
    :_ObjectListPath_3 => {
      "," => [",", :ObjectPath, :_ObjectListPath_5],
    },
    :_ObjectListPath_4 => {
      "," => [:_ObjectListPath_3, :_ObjectListPath_2],
    },
    :_ObjectListPath_5 => {
      "," => [],
      "." => [],
  ...
  CLEANUP = {
    ...
    :_ObjectListPath_1 => :opt,
    :_ObjectListPath_2 => :star,
    :_ObjectListPath_4 => :merge,
    :_ObjectListPath_5 => :opt,
    :_ObjectList_1 => :opt,
    :_ObjectList_2 => :star,
    :_ObjectList_4 => :merge,
    :_ObjectList_5 => :opt,
