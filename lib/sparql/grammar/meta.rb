...
module SPARQL::Grammar::Meta
  ...
  BRANCH = {
    ...
    :_BindingsClause_9 => {
      ...
      :IRIREF => [:BindingValue, :_BindingsClause_8],
    ...
    :IRIrefOrFunction => {
      :IRIREF => [:IRIref, :_IRIrefOrFunction_1],
    ...
    :Query => {
      "ASK" => [:Prologue, :_Query_1, :BindingsClause],
      "BASE" => [:Prologue, :_Query_1, :BindingsClause],
      "CONSTRUCT" => [:Prologue, :_Query_1, :BindingsClause],
      "DESCRIBE" => [:Prologue, :_Query_1, :BindingsClause],
